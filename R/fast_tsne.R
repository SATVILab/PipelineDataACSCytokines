#' @title Compute FIt-SNE of a dataset
#' 
#' @param dims dimensionality of the embedding. Default 2.
#' @param perplexity perplexity is used to determine the
...
#' @param exaggeration_factor coefficient for early exaggeration
#'          (>1). Default 12.
...
#'           Default -1 (None)
#' @param K Number of nearest neighbours to get when using fixed sigma
#'           Default -30 (None)
#
#' @param initialization  'pca', 'random', or N x no_dims array to intialize the solution.
#'           Default: 'pca'
#
...
#' @param FAST_TSNE_SCRIPT_DIR character. 
